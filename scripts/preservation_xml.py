...
validate = subprocess.run(f'xmllint --noout -schema "{stylesheets}/preservation.xsd" "{preservationxml}"', stderr=subprocess.PIPE, shell=True)


# If the preservation.xml isn't valid, moves the aip to an error folder and
...
# If the preservation.xml is valid, copies the preservation.xml to local server for staff use.
